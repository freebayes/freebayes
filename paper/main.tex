...
% problem, these results are old, and the depths are all messed up
% temporary fix is to focus on 10x data, 100 samples as an intermediate place between high and low, few and many samples
\begin{comment}
\begin{table}
\centering
...
        FreeBayes        & 20               & 1        & 0.9951796               & 0.9778426                 \\ 
        ~                & 50               & 1        & 0.9995107               & 0.9861183                 \\
        ~                & 100              & 1        & 0.9994589               & 0.9908615                 \\
        ~                & 200              & 1        & 0.9992723               & 0.9904454                 \\
        ~                & 100              & 10       & 0.9990198               & 0.9887222                 \\
        ~                & 10               & 1000     & 0.9506019               & 0.8238546                 \\
        \hline
        GATK             & 20               & 1        & 0.9597245               & 0.9239944                 \\ 
        ~                & 50               & 1        & 0.9855856               & 0.9528566                 \\
        ~                & 100              & 1        & 0.9873314               & 0.9571918                 \\
        ~                & 200              & 1        & 0.9919423               & 0.9495481                 \\
        ~                & 100              & 10       & 0.9982619               & 0.9525444                 \\
        ~                & 10               & 1000     & 0.9096740               & 0.6765572                 \\
        \hline
        samtools         & 20               & 1        & 0.9512304               & 0.9453896                 \\ 
        ~                & 50               & 1        & 0.9600118               & 0.9157335                 \\
        ~                & 100              & 1        & 0.9558301               & 0.9070483                 \\
        ~                & 200              & 1        & 0.9578685               & 0.8855712                 \\
        ~                & 100              & 10       & 0.9655211               & 0.8313119                 \\
        ~                & 10               & 1000     & 0.6156088               & 0.5138672                 \\ \hline
    \end{tabular}
\end{comment}
...
%This avoids the requirement of a known truth set, although such post-processing methods can still be applied to results for further improvement in detection performance.
...
% TODO, bug ... allele balance is implemented as a multinomial coefficient
\begin{eqnarray}
